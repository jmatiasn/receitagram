...
public class HomeFragment extends Fragment {
    ...
    private List<Receita> obterReceitas(List<Receita> mReceitas) {
        ...
        modoDePreparo = "Cozinhar a couve-flor com sal até ficar bem macia., "
        ...
        //RECEITA 3 ---------------------------------------------------------
        ingredientes = "2 latas de atum em óleo,"
        ...
        modoDePreparo = "Em uma tigela, misture todos os ingredientes, "
        ...
        //RECEITA 4 ---------------------------------------------------------
        ingredientes = "2 copos (americano) de leite, "
                + "2 colheres (sopa) de margarina, "
                + "1 cubo de caldo de galinha, "
                + "2 copos (americano) de farinha de trigo, "
                + "1/2 kg de mandioca cozida, ";
        modoDePreparo = "Leve ao fogo: leite, margarina, caldo, "
        ...
        //RECEITA 5 ---------------------------------------------------------
        ingredientes = "1/2 kg de carne moída, "
                + "1 pacote de sopa de cebola, "
                + "presunto fatiado, "
                + "queijo fatiado, "
                + "tempero verde, "
                + "sal a gosto";
        modoDePreparo = "Tempere a carne moída com a sopa de cebola, o tempero verde e o sal, "
